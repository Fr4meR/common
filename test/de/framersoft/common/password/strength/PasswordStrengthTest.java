...
public class PasswordStrengthTest {
	...
	public void testCalculatePasswordStrengthRating() {
		...
		assertEquals(PasswordStrength.PASSWORD_STRENGTH_STRONG, PasswordStrength.calculatePasswordStrengthRating("Hesind_�8"));
	...
	public void testCalculateSpace() {
		...
		assertEquals(6, PasswordStrength.calculateSpace("���"));
		assertEquals(58, PasswordStrength.calculateSpace("UpperLowerUml��te"));
	}
